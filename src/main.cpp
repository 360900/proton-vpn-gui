...
int main(int argc, char* argv[])
{
    ...
    QPalette palette;
    const QColor bg(0x1a, 0x1a, 0x2e);          // deep navy background
    const QColor surface(0x25, 0x25, 0x3d);      // card surface
    const QColor border(0x3a, 0x3a, 0x55);       // borders
    const QColor accent(0x6d, 0x4a, 0xff);       // Proton purple
    const QColor textPrimary(0xea, 0xea, 0xea);  // near-white text
    const QColor textSecondary(0x99, 0x99, 0xbb);
    const QColor highlight(0x6d, 0x4a, 0xff);
